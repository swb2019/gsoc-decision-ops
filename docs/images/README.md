...
- Use Chrome DevTools device mode at 1280px width
- Use the live demo at `npm run dev` on localhost:3000
- Capture PNG format at 2x resolution for retina displays
...
3. Capture using browser screenshot tools
